...
xl = [0.4; 0.4; 0.4; -0.5; 3.5; 0.7];
xr = [0.6; 0.6; 0.6; 0.5; 4.5; 0.9];
...
parfor jj = 1:N
    ...
    init_guess = Vlasov_1D_linearized_Steve_v3_Kappa( ...
        params(1), [params(2), params(3)], [params(4), params(5)], params(6), kappa);
    growth(jj) = Kappa_Disp_Relation_BumponTail( ...
        params(1), [params(2), params(3)], [params(4), params(5)], params(6), init_guess);
...
parfor jj = 1:N
    ...
    for kk = 1:Nparams
        ...
        init_guess_plus = Vlasov_1D_linearized_Steve_v3_Kappa( ...
            paramsplus(1), [paramsplus(2), paramsplus(3)], [paramsplus(4), paramsplus(5)], paramsplus(6), kappa);
        growth_plus(jj) = Kappa_Disp_Relation_BumponTail( ...
            paramsplus(1), [paramsplus(2), paramsplus(3)], [paramsplus(4), paramsplus(5)], paramsplus(6), init_guess_plus);
