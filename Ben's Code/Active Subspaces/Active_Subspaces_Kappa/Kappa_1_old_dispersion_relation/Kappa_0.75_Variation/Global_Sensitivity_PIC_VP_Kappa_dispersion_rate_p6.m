% 12/30 - Updated to add mu parameter
% active subspaces old
...
parfor jj = 1:N
    ...
    growth(jj) = Kappa_Disp_Relation(params(1), params(2), params(3), init_guess);
...
parfor jj = 1:N
    ...
    for kk = 1:Nparams
        ...
        growth_plus(jj, kk) = Kappa_Disp_Relation(paramsplus(1), paramsplus(2), paramsplus(3), init_guess_plus);
