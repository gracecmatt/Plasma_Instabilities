...
paramARR = linspace(0.01,0.25,48);
xaxis = "k"; 
...
% Bohm-Gross approximation
figure
plot(paramARR,imag(omegaExact(1,:)),'-','linewidth',2); hold on
plot(paramARR,imag(omegaXieShiftScaled(1,:)),'*','linewidth',4,'MarkerSize',4);
plot(paramARR,imag(omegaBohmGross(1,:)),'s','linewidth',1,'MarkerSize',6)
plot(paramARR,imag(omegaExact(2,:)),'-','linewidth',2); 
plot(paramARR,imag(omegaXieShiftScaled(2,:)),'*','linewidth',4,'MarkerSize',4);
plot(paramARR,imag(omegaBohmGross(2,:)),'s','linewidth',1,'MarkerSize',6);
title('\textbf{Kappa $\mathbf{\gamma(k)}$ Level Curves}','FontSize',16);
    legend('Exact $(\kappa\!=\!2)$','Weideman $(\kappa\!=\!2)$','Bohm-Gross $(\kappa\!=\!2)$','Exact $(\kappa\!=\!4)$','Weideman $(\kappa\!=\!4)$','Bohm-Gross $(\kappa\!=\!4)$','Location','SouthWest','Interpreter','latex','FontSize',12);
