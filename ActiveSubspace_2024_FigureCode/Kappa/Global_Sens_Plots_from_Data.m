...
txt = ['\textbf{Kappa ($\kappa\!=\!',int2str(kappa),'$), ',int2str(var*100),'\% Variation}'];
...
saveas(gcf, ['Figs/EigWVSSPfit_Dispersion_Kap' int2str(kappa) '_' int2str(Nparams) '_' int2str(N) '_' int2str(100*var) '_' int2str(deg) '.pdf'])
saveas(gcf, ['Figs/EigWVSSPfit_Dispersion_Kap' int2str(kappa) '_' int2str(Nparams) '_' int2str(N) '_' int2str(100*var) '_' int2str(deg) '.fig'])