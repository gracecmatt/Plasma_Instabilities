...
saveas(gcf, ['Figs/Eig2fit_Dispersion_IMax_' int2str(Nparams) '_' int2str(N) '_' int2str(100*var) '.pdf'])
saveas(gcf, ['Figs/Eig2fit_Dispersion_IMax_' int2str(Nparams) '_' int2str(N) '_' int2str(100*var) '.fig'])
saveas(gcf, ['Figs/Eig2fit_Dispersion_IMax_' int2str(Nparams) '_' int2str(N) '_' int2str(100*var) '.svg'])
...
scatter3(Xs*w_1_1var, Xs*w_2_1var, Xs*w_3_1var, 60, growth_1var, 'o', 'filled','MarkerEdgeColor',[0 0 0]);
    colormap(bluewhitered); c2 = colorbar;
    xlabel('$w_1^Tp_j$','Fontsize',14)
    ylabel('$w_2^Tp_j$','Fontsize',14)
    zlabel('$w_3^Tp_j$','Fontsize',14)
    ylabel(c2,'Growth Rate','FontSize',14,'Rotation',270,'Interpreter','latex');
...
set(gcf, 'PaperPosition', [0 0 6 4.5]); %Position the plot further to the upper-left conder
set(gcf, 'PaperSize', [6 4.5]); % Extends the plot to fill the entire paper
saveas(gcf, ['Figs/Eig3fit_Dispersion_IMax_' int2str(Nparams) '_' int2str(N) '_' int2str(100*var) '.pdf'])
saveas(gcf, ['Figs/Eig3fit_Dispersion_IMax_' int2str(Nparams) '_' int2str(N) '_' int2str(100*var) '.fig'])
saveas(gcf, ['Figs/Eig3fit_Dispersion_IMax_' int2str(Nparams) '_' int2str(N) '_' int2str(100*var) '.svg'])
