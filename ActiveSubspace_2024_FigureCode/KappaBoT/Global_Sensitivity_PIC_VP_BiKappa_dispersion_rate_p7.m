...
setvals = [0.5; 1; 0.38; 1; 4; 0.86; kappa];
...
if kappa == 2
    ...
    xl(7) = max(xl(7),1.525); % keep kappa > 1.5
elseif kappa == 4
...
for jj = 1:N
    ...
    omega = KappaBoT_Disp_Using_Xie(params(1)*params(2),1,params(3)/params(2),0,params(5)/params(2),params(6),params(7),xi_guess)*params(2)*params(1);% + params(4)*params(1);
...
parfor jj = 1:N
    ...
    for kk = 1:Nparams
        ...
        omega_plus = KappaBoT_Disp_Using_Xie(paramsplus(1)*paramsplus(2),1,paramsplus(3)/paramsplus(2),0,paramsplus(5)/paramsplus(2),paramsplus(6),paramsplus(7),xi_guess_plus)*paramsplus(2)*paramsplus(1);
...
%Save the trial data
save(['Data/Dispersion_KappaBoT' int2str(kappa) '_P' int2str(Nparams) '_N' int2str(N) '_var' int2str(var*100) '_data.mat'])
