...
## calFp( )
**Objective:** Symbolically compute the derviative of `F` and set it to a string `Fp`.  
**Inputs:** `F` = distribution function (string)  
**Outputs:** `F` = distribution function (string), `Fp` = derivative of distribution function (string)  
```matlab
...
```
## zdelta( )
**Objective:** Defines the delta function "distribution".  
**Inputs:** `z` = complex independent variable, `zd` = 0, center of delta function  
**Outputs:** `F` = distribution function (string), `Fp` = derivative of distribution function (string)  
```matlab
...
```
## calz( )
**Objective:** Runs the function `hilb( )` avoiding singularities in `F`.   
**Inputs:**  
**Outputs:** 
```matlab
...
## hilb( )
**Objective:** Computes `Z` from the given distribution function `F`.   
**Inputs:**   
**Outputs:** 
```matlab
