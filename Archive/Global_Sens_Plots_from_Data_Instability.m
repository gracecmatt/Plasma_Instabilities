...
hgexport(fig6, ['Figs/EigWVSSPfit_Dispersion_Kappa' int2str(kappa) '_' int2str(Nparams) '_' int2str(N) '_' int2str(100*var) '_' int2str(deg) '.eps'], hgexport('factorystyle'), 'Format', 'eps');
hgexport(fig6, ['Figs/EigWVSSPfit_Dispersion_Kappa' int2str(kappa) '_' int2str(Nparams) '_' int2str(N) '_' int2str(100*var) '_' int2str(deg) '.svg'], hgexport('factorystyle'), 'Format', 'svg');