...
var = 0.75; % x 100% variation considered 
xl = (1-var)*setvals;
xu = (1+var)*setvals;
...
parfor jj = 1:N
    ...
    growth(jj) = dielectric_kappa(params(1), params(2), params(2), params(3), params(3), 1, kappa, init_guess);
...
parfor jj = 1:N
    ...
    for kk = 1:Nparams
        ...
        growth_plus(jj, kk) = dielectric_kappa(paramsplus(1), paramsplus(2), paramsplus(2), paramsplus(3), paramsplus(3), 1, kappa, init_guess_plus);
