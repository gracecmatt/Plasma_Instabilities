...
% Changed on 12/13/22
C=(pi*theta^2*kappa^3)^(-1/2)*exp(gammaln(kappa+1)-gammaln(kappa-0.5));
f0=C*(1+(v-mu).^2/(kappa*theta^2)).^(-kappa); 
f0_v=C*(-kappa)*2*(v-mu)/(kappa*theta^2).*(1+(v-mu).^2/(kappa*theta^2)).^(-kappa-1); 
