...
parfor jj = 1:N
    ...
    % growth(jj) = dielectric_kappa(params(1), params(2),1,params(3),0,1,1,init_guess); 
...
parfor jj = 1:N
    ...
    for kk = 1:Nparams
        ...
        % growth_plus(jj,kk) = dielectric_kappa(paramsplus(1), paramsplus(2),1,paramsplus(3),0,1,1,init_guess_plus); 
