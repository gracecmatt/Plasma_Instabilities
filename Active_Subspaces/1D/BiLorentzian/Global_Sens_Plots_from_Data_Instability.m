...
txt = ['BiLorentzian, ',int2str(var*100),'\% variation on ($k,\sigma_1,\sigma_2,\mu_1,\mu_2,\beta)=$(',num2str(setvals(1)),',',num2str(setvals(2)),',',num2str(setvals(3)),',',num2str(setvals(4)),',',num2str(setvals(5)),',',num2str(setvals(6)),')'];
