...
parfor jj = 1:N
    ...
    init_guess = Vlasov_1D_linearized_Steve_v4_Kappa(params(1),params(2),params(3),0,params(5)-params(4),params(6),kappa);
    xi_guess = init_guess/(params(2)*params(1)); % shifted and scaled

    omega = BiKappa_Disp_Using_Xie(params(1)*params(2),1,params(3)/params(2),0,(params(5)-params(4))/params(2),params(6),kappa,xi_guess)*params(2)*params(1) + params(4)*params(1);
...
parfor jj = 1:N
    ...
    for kk = 1:Nparams
        ...
        init_guess_plus = Vlasov_1D_linearized_Steve_v4_Kappa(paramsplus(1),paramsplus(2),paramsplus(3),0,paramsplus(5)-paramsplus(4),paramsplus(6),kappa);
        xi_guess_plus = init_guess_plus/(paramsplus(2)*paramsplus(1));
        
        omega0_plus = BiKappa_Disp_Using_Xie(paramsplus(1)*paramsplus(2),1,paramsplus(3)/paramsplus(2),0,(paramsplus(5)-paramsplus(4))/paramsplus(2),paramsplus(6),kappa,xi_guess_plus)*paramsplus(2)*paramsplus(1);
