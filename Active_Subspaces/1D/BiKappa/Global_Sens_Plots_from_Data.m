...
set(gca,'XTickLabel',{'$k$' '$\sigma_1$' '$\sigma_2$' '$\mu_1$' '$\mu_2$' '$\beta$' '$\kappa$'})
...
txt = ['BiKappa, ',int2str(var*100),'% Variation'];
sgtitle(txt,'Fontsize',23,'FontWeight','bold');

hgexport(fig6, ['Figs\EigWVSSPfit_Dispersion_BiKap' int2str(kappa) '_' int2str(100*var) '_' int2str(N) '_' int2str(deg) '.eps']);
hgexport(fig6, ['Figs\EigWVSSPfit_Dispersion_BiKap' int2str(kappa) '_' int2str(100*var) '_' int2str(N) '_' int2str(deg) '.pdf']);