...
hgexport(fig6, ['Figs/EigWVSSPfit_Dispersion_Kappa_' int2str(100*var) '_' int2str(N) '_' int2str(deg) '.eps'], hgexport('factorystyle'), 'Format', 'eps');
hgexport(fig6, ['Figs/EigWVSSPfit_Dispersion_Kappa_' int2str(100*var) '_' int2str(N) '_' int2str(deg) '.svg'], hgexport('factorystyle'), 'Format', 'svg');
%hgexport(fig6, ['EigWVSSPfit_Dispersion_BiMax_global_' int2str(N) '_' int2str(deg) '.eps'], hgexport('factorystyle'), 'Format', 'eps');
hgexport(fig6, ['Figs/EigWVSSPfit_Dispersion_Kappa_' int2str(100*var) '_' int2str(N) '_' int2str(deg) '.pdf'], hgexport('factorystyle'), 'Format', 'pdf');
