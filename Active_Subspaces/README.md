...
- 1D Kappa $f_{\kappa}(v) = \frac{1}{\sqrt{\pi\theta^2\left(\kappa-\frac{1}{2}\right)}}\frac{\Gamma(\kappa+1)}{\Gamma(\kappa+1/2)}\left[1+\frac{1}{\kappa-\frac{1}{2}}\frac{({v}-{\mu})^2}{\theta^2}\right]^{-\kappa-1}$
    - See sufficient summary plots with $k=0.5, \theta=1, \mu=0$ [HERE.]([Active_Subspaces/1D/Kappa/README.md](https://github.com/gracecmatt/Plasma_Instabilities/tree/main/Active_Subspaces/1D/Kappa/README.md)) 
